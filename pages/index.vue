        ...
        <div class="section-fluid pb-0 pt-5">
            <div class="container">
                <div class="banner-slider mb-5" id="bannerSlider">
                    <swiper :options="bannerShopOption">
                        <div class="swiper-slide" v-for="(item, index) in slider" :key="index">
                            <a target="_blank" href="#" class="w-100">
                                <img :src="sliderOne" alt="banner" class="w-100" />
                            </a>
                        </div>
                    </swiper>
                ...
                <!-- <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <nuxt-link :to="{ path: '/product' }" class="btn btn-md btn-primary px-3 py-2">lihat Semua Produk</nuxt-link>
                </div>
